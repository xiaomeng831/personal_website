      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br /><br />Before I came here, I was a developer with <span className="azure">5 years</span> work experience mainly on <span className="azure">Spring Boot</span> and <span className="azure">React.js</span>. 
